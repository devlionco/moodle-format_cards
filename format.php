...
if (($deletesection = optional_param('deletesection', 0, PARAM_INT)) && confirm_sesskey()) {
    ...
    $renderer->display_sections($course, $displaysection, $displaysection);
}

// Include course format js module
$PAGE->requires->js('/course/format/cards/format.js');
$PAGE->requires->string_for_js('confirmdelete', 'format_cards');
// $PAGE->requires->js_init_call('M.course.format.init_flexsections');

$PAGE->requires->js_call_amd('format_cards/togglePopup', 'init');
